...
for model in ["uncompiled"]: #compiled не работает
    ...
    for epochs in epoch_list:
        ...
        if model == "compiled":
            pt_model = torch.compile(three_layer_model().to(device), mode= "reduce-overhead")
        else:
        ...
        plt.legend()
        plt.savefig(f"training_loss_plot_PT_cuda{epochs}.png")  # Сохранение в файл
        print(f"График сохранён как 'training_loss_plot_PT_cuda{epochs}.png'")
        print("\n---------------------\n")
        plt.close()
